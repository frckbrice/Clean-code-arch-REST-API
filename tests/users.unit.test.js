...
describe('User Controller Unit Tests', () => {
    it('should register a user (mocked)', async () => {
        ...
        const httpRequest = { body: { username: 'testuser', email: 'test@example.com', password: 'pass' } };
    ...
    it('should get user profile (mocked)', async () => {
        const findOneUserUseCaseHandler = jest.fn().mockResolvedValue({ id: 'u1', username: 'testuser' });
        const makeHttpError = jest.fn((obj) => ({ ...obj }));
        const logEvents = jest.fn();
