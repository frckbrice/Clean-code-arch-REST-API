...
module.exports = {
  ...
  loginUserController: ({
    ...
    return async function loginUserControllerHandler(httpRequest) {
      ...
      try {
        ...
        const cookies = Object.entries(maxAge)
          .map(([name, age]) => {
  ...
  refreshTokenUserController: ({
    ...
    async function refreshTokenUserControllerHandler(httpRequest) {
  ...
  forgotPasswordController: ({
    ...
    async function forgotPasswordControllerHandler(httpRequest) {
      ...
      forgotPasswordUseCaseHandler({ email })
        .then((forgotPasswordUserData) => {
