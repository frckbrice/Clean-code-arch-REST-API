...
const createProductController = ({
  ...
  async function createProductControllerHandler(httpRequest) {
    ...
    return createProductUseCaseHandler({
      createProductDbHandler: dbProductHandler.createProductDbHandler,
      errorHandlers,
      productData,
    })
      .then((createdProduct) => {
...
const findOneProductController = ({
  ...
  async function findOneProductControllerHandler(httpRequest) {
    ...
    try {
      const product = await findOneProductUseCaseHandler({
        productId,
        logEvents,
        findOneProductDbHandler: dbProductHandler.findOneProductDbHandler,
        errorHandlers,
      });
      return {
        headers: {
...
const findAllProductController = ({ dbProductHandler, findAllProductUseCaseHandler, logEvents }) =>
  async function findAllProductControllerHandler(httpRequest) {
...
const deleteProductController = ({
  ...
  async function deleteProductControllerHandler(httpRequest) {
    const { productId } = httpRequest.params;
    if (!productId) {
      return {
        headers: {
...
const updateProductController = ({
  ...
  async function updateProductControllerHandler(httpRequest) {
    const { productId } = httpRequest.params;
    let { body } = httpRequest;
    ...
    return updateProductUseCaseHandler({
      productId,
      updateData: body,
      logEvents,
      dbProductHandler,
...
const rateProductController = ({
  ...
  async function rateProductControllerHandler(httpRequest) {
    const { userId, ratingValue, productId } = httpRequest.body;
